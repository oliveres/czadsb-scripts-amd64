...
wget http://mirrors.mediatemple.net/debian-archive/debian/pool/main/o/openssl/libssl1.0.0_1.0.2l-1~bpo8+1_amd64.deb
...
sed -i "s/USERNAME/$username/g" ~/modesmixer2/czadsb.modesmixer.sh
