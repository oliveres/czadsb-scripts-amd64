...
sudo apt-get update
sudo apt install git lighttpd debhelper librtlsdr-dev pkg-config dh-systemd libncurses5-dev libbladerf-dev libusb-1.0-0-dev python libhackrf-dev liblimesuite-dev -y
